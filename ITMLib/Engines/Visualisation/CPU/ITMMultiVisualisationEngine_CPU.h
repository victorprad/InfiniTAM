...
namespace ITMLib 
{
	...
	public:
		...
		void RenderImage(const ORUtils::SE3Pose *pose, const ITMIntrinsics *intrinsics, ITMRenderState *renderState, ORUChar4Image *outputImage, IITMVisualisationEngine::RenderImageType type) const;
	};
}
