...
//	Vector2i viewImageSize = viewHierarchyLevel_Intensity->rgb_current->noDims;
//
//	Vector4f *locations = sceneHierarchyLevel_RGB->pointsMap->GetData(MEMORYDEVICE_CPU);
//	Vector4f *rgb_model = previousProjectedIntensityLevel->depth->GetData(MEMORYDEVICE_CPU);
//	Vector4u *rgb_live = viewHierarchyLevel_Intensity->rgb_current->GetData(MEMORYDEVICE_CPU);
//	Vector4s *gx = viewHierarchyLevel_Intensity->gX->GetData(MEMORYDEVICE_CPU);
//	Vector4s *gy = viewHierarchyLevel_Intensity->gY->GetData(MEMORYDEVICE_CPU);
//
...
{
//	Vector2i imageSize = viewHierarchyLevel_Intensity->rgb_prev->noDims;
...
//	Vector4u *rgbIn = viewHierarchyLevel_Intensity->rgb_prev->GetData(MEMORYDEVICE_CPU);
//	Vector4f *rgbOut = previousProjectedIntensityLevel->depth->GetData(MEMORYDEVICE_CPU);
//
