...
template<typename T> _CPU_AND_GPU_CODE_ inline Vector3f reproject(const THREADPTR(ORUtils::Vector2<T>) &point_2d, const THREADPTR(float) depth, const THREADPTR(Vector4f) &intrinsics)
{
