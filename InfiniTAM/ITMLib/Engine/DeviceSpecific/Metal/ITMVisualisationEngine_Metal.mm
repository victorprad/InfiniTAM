...
ITMVisualisationEngine_Metal<TVoxel, TIndex>::ITMVisualisationEngine_Metal() { }
...
ITMVisualisationEngine_Metal<TVoxel, ITMVoxelBlockHash>::ITMVisualisationEngine_Metal()
{
    ...
    f_createICPMaps_vh_device = [[[ITMMetalContext instance]library]newFunctionWithName:@"createICPMaps_vh_device"];
    p_createICPMaps_vh_device = [[[ITMMetalContext instance]device]newComputePipelineStateWithFunction:f_createICPMaps_vh_device error:&errors];
    
    f_createICPMaps_vh_normals_device = [[[ITMMetalContext instance]library]newFunctionWithName:@"createICPMaps_vh_normals_device"];
    p_createICPMaps_vh_normals_device = [[[ITMMetalContext instance]device]newComputePipelineStateWithFunction:f_createICPMaps_vh_normals_device error:&errors];
    
    paramsBuffer_visualisation = BUFFEREMPTY(16384);
}

template<class TVoxel>
ITMVisualisationEngine_Metal<TVoxel,ITMVoxelBlockHash>::State::State(const Vector2i & imgSize)
...
template<class TVoxel>
ITMVisualisationEngine_Metal<TVoxel,ITMVoxelBlockHash>::State::~State(void)
{
...
template<class TVoxel, class TIndex>
void ITMVisualisationEngine_Metal<TVoxel,TIndex>::FindVisibleBlocks(const ITMScene<TVoxel,TIndex> *scene, const ITMPose *pose, const ITMIntrinsics *intrinsics, ITMVisualisationState *_state)
{
}

template<class TVoxel>
void ITMVisualisationEngine_Metal<TVoxel,ITMVoxelBlockHash>::FindVisibleBlocks(const ITMScene<TVoxel,ITMVoxelBlockHash> *scene, const ITMPose *pose, const ITMIntrinsics *intrinsics, ITMVisualisationState *_state)
{
...
template<class TVoxel, class TIndex>
void ITMVisualisationEngine_Metal<TVoxel,TIndex>::CreateExpectedDepths(const ITMScene<TVoxel,TIndex> *scene, const ITMPose *pose, const ITMIntrinsics *intrinsics, ITMImage<Vector2f> *minmaximg, const ITMVisualisationState *state)
{
...
template<class TVoxel>
void ITMVisualisationEngine_Metal<TVoxel,ITMVoxelBlockHash>::CreateExpectedDepths(const ITMScene<TVoxel,ITMVoxelBlockHash> *scene, const ITMPose *pose, const ITMIntrinsics *intrinsics, ITMImage<Vector2f> *minmaximg, const ITMVisualisationState *state)
{
    Vector2i imgSize = minmaximg->noDims;
    Vector2f *minmaxData = minmaximg->GetData(false);
...
template<class TVoxel, class TIndex>
static void RenderImage_common(const ITMScene<TVoxel,TIndex> *scene, const ITMPose *pose, const ITMIntrinsics *intrinsics, const ITMVisualisationState *state,
...
class RaycastRenderer_PointCloud {
    ...
    public:
    RaycastRenderer_PointCloud(Vector4u *_outRendering, Vector4f *_locations, Vector4f *_colours, uint & _noTotalPoints, float _voxelSize,
                               bool _skipPoints, const TVoxel *_voxelData, const typename TIndex::IndexData *_voxelIndex)
...
template<class TVoxel, class TIndex>
void ITMVisualisationEngine_Metal<TVoxel,TIndex>::RenderImage(const ITMScene<TVoxel,TIndex> *scene, const ITMPose *pose, const ITMIntrinsics *intrinsics,
                                                              const ITMVisualisationState *state, ITMUChar4Image *outputImage, bool useColour)
{
    RenderImage_common(scene, pose, intrinsics, state, outputImage, useColour);
}

template<class TVoxel>
void ITMVisualisationEngine_Metal<TVoxel,ITMVoxelBlockHash>::RenderImage(const ITMScene<TVoxel,ITMVoxelBlockHash> *scene, const ITMPose *pose,
                                                                         const ITMIntrinsics *intrinsics, const ITMVisualisationState *state, ITMUChar4Image *outputImage, bool useColour)
{
    RenderImage_common(scene, pose, intrinsics, state, outputImage, useColour);
}

template<class TVoxel, class TIndex>
void ITMVisualisationEngine_Metal<TVoxel,TIndex>::CreatePointCloud(const ITMScene<TVoxel,TIndex> *scene, const ITMView *view,
                                                                   ITMTrackingState *trackingState, bool skipPoints)
{
    CreatePointCloud_common(scene, view, trackingState, skipPoints);
}

template<class TVoxel>
void ITMVisualisationEngine_Metal<TVoxel,ITMVoxelBlockHash>::CreatePointCloud(const ITMScene<TVoxel,ITMVoxelBlockHash> *scene, const ITMView *view,
                                                                              ITMTrackingState *trackingState, bool skipPoints)
{
    CreatePointCloud_common(scene, view, trackingState, skipPoints);
}
...
template<class TVoxel, class TIndex>
void ITMVisualisationEngine_Metal<TVoxel,TIndex>::CreateICPMaps(const ITMScene<TVoxel,TIndex> *scene, const ITMView *view, ITMTrackingState *trackingState)
{
    CreateICPMaps_common(scene, view, trackingState);
}

template<class TVoxel>
void ITMVisualisationEngine_Metal<TVoxel,ITMVoxelBlockHash>::CreateICPMaps(const ITMScene<TVoxel,ITMVoxelBlockHash> *scene, const ITMView *view,
