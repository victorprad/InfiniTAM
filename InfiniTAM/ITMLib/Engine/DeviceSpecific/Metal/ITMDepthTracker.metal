...
kernel void depthTrackerOneLevel_g_rt_device(DEVICEPTR(float) *noValidPoints                            [[ buffer(0) ]],
                                             ...
                                             const DEVICEPTR(Vector4f) *pointsMap                       [[ buffer(5) ]],
                                             const DEVICEPTR(Vector4f) *normalsMap                      [[ buffer(6) ]],
                                             const CONSTANT(DepthTrackerOneLevel_g_rg_Params) *params   [[ buffer(7) ]],
