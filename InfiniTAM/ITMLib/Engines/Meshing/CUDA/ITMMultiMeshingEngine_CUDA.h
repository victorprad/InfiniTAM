...
namespace ITMLib
{
	...
	{
	public:
		void MeshScene(ITMMesh *mesh, const ITMMultiSceneManager_instance<TVoxel, TIndex> & sceneManager) {}
	};
	...
	public:
		...
		typedef ITMMultiSceneManager_instance<TVoxel, ITMVoxelBlockHash> MultiSceneManager;
