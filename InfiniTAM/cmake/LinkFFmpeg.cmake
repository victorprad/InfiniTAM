...
IF(WITH_FFMPEG)
  ...
  IF(MSVC_IDE)
    ...
    ADD_CUSTOM_COMMAND(TARGET ${targetname} POST_BUILD COMMAND ${CMAKE_COMMAND} -E copy_if_different "${FFmpeg_SHARED_ROOT}/bin/postproc-54.dll" "$<TARGET_FILE_DIR:${targetname}>")
    ADD_CUSTOM_COMMAND(TARGET ${targetname} POST_BUILD COMMAND ${CMAKE_COMMAND} -E copy_if_different "${FFmpeg_SHARED_ROOT}/bin/swresample-2.dll" "$<TARGET_FILE_DIR:${targetname}>")
    ADD_CUSTOM_COMMAND(TARGET ${targetname} POST_BUILD COMMAND ${CMAKE_COMMAND} -E copy_if_different "${FFmpeg_SHARED_ROOT}/bin/swscale-4.dll" "$<TARGET_FILE_DIR:${targetname}>")
  ENDIF()
ENDIF()
