...
namespace InfiniTAM
{
	namespace Engine
	{
		...
		public:
			...
			void Initialise(InputSource::ImageSourceEngine *imageSource, InputSource::IMUSourceEngine *imuSource, ITMLib::ITMMainEngine *mainEngine, ORUtils::DeviceType deviceType);
			void Shutdown();
